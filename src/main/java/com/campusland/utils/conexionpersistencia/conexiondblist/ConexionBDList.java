...
public class ConexionBDList {
    ...
    private void getLoadDataProductos() {
     ...
     private void getLoadDataFactura() {
        ...
        Factura factura1 = new Factura(0, LocalDateTime.now(),
        ...
        Factura factura2 = new Factura(0, LocalDateTime.now(), new Cliente("Celina", "Torres", "celinat@gmail.com", "dirección", "celular", "13822009", 0, listFacturas));
        ...
        Factura factura3 = new Factura(0, LocalDateTime.now(),
    ...
    public List<DescuentoFactura> getListaDescuentos() {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'getListaDescuentos'");
    }
